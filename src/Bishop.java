...
public class Bishop extends Piece {
	...
	public Bishop(final boolean black) {
		this.black = black;
		if (black) {
			image = this.getClass().getResource("/images/bBishop.png").getPath();
		} else {
			image = this.getClass().getResource("/images/wBishop.png").getPath();
		}
	}
	...
	protected boolean checkIfPathClear(int[] currentPos, int[] moveTo) {
		...
		return checkInDirectionStraight(stepCountX, getVector(stepCountX), stepCountX + stepCountY, currentPos, true);
	}
